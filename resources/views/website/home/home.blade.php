 ...
 <!-- Start Banner Area
        ...
        <div class="banner-fade">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide banner-style-one">
                    <div class="banner-thumb bg-cover shadow dark" style="background: url({{ asset('public/website/assets/img/banner/17.jpg') }})"></div>
                    <div class="container">
                ...
                <!-- Single Item -->
                <div class="swiper-slide banner-style-one">
                    <div class="banner-thumb bg-cover shadow dark" style="background: url({{ asset('public/website/assets/img/banner/2.jpg') }})"></div>
                    <div class="container">
                        <div class="row align-center">
                            <div class="col-xl-7">
                                <div class="content">
    ...
    <div class="about-style-one-area default-padding">
        ...
        <div class="shape-right-top">
            <img src="{{ asset('public/website/assets/img/shape/leaf.png') }}" alt="Image not found">
        </div>
        <!-- End Shape -->
        ...
        <div class="container">
            <div class="row align-center">
                <div class="col-xl-5 col-lg-6 about-style-one pr-50 pr-md-15 pr-xs-15">
                    <div class="thumb">
                        <img src="{{ asset('public/website/assets/img/about/5.jpg') }}" alt="Image Not Found">
                        <div class="sub-item">
                            <img src="{{ asset('public/website/assets/img/about/1.jpg') }}" alt="Image Not Found">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row align-center">
                        ...
                        <div class="col-xl-5 col-lg-12 pl-50 pl-md-15 pl-xs-15">
                            <div class="top-product-item">
                                <img src="{{ asset('public/website/assets/img/icon/1.svg') }}" alt="Icon">
                            ...
                            <div class="top-product-item">
                                <img src="{{ asset('public/website/assets/img/icon/2.svg') }}" alt="Icon">
    ...
    <div class="services-style-one-area default-padding bg-gray half-bg-theme">
        <div class="shape-extra">
            <img src="{{ asset('public/website/assets/img/shape/18.png') }}" alt="Image Not Found">
        </div>
        <div class="container">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="services-style-one">
                                    <div class="thumb">
                                        <img src="{{ asset('public/website/assets/img/thumb/1.png') }}" alt="Image Not Found">
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="services-style-one">
                                    <div class="thumb">
                                        <img src="{{ asset('public/website/assets/img/thumb/2.png') }}" alt="Image Not Found">
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="services-style-one">
                                    <div class="thumb">
                                        <img src="{{ asset('public/website/assets/img/thumb/3.png') }}" alt="Image Not Found">
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="services-style-one">
                                    <div class="thumb">
                                        <img src="{{ asset('public/website/assets/img/thumb/4.png') }}" alt="Image Not Found">
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="services-style-one">
                                    <div class="thumb">
                                        <img src="{{ asset('public/website/assets/img/thumb/6.png') }}" alt="Image Not Found">
                                    </div>
    ...
    <div class="product-list-area default-padding-bottom bottom-less bg-dark text-center text-light">
        <div class="shape-bottom-right">
            <img src="{{ asset('public/website/assets/img/shape/21.png') }}" alt="Image Not Found">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-xl-10 offset-xl-1 mb-50 mb-xs-30">
                    <h2 class="mask-text" style="background-image: url({{ asset('public/website/assets/img/banner/3.jpg') }}">Healthy life with fresh products</h2>
                </div>
                <div class="product-list-box">
                    <!-- Single Item -->
                    <div class="product-list-item">
                        <a href="services-details.html">
                            <img src="{{ asset('public/website/assets/img/icon/1.png') }}" alt="Icon">
                            <h5>Blueberry</h5>
                        </a>
                    </div>
                    <!-- End Single Item -->
                    ...
                    <div class="product-list-item">
                        <a href="services-details.html">
                            <img src="{{ asset('public/website/assets/img/icon/2.png') }}" alt="Icon">
                            <h5>Strawberry</h5>
                        </a>
                    </div>
                    <!-- End Single Item -->
                    ...
                    <div class="product-list-item">
                        <a href="services-details.html">
                            <img src="{{ asset('public/website/assets/img/icon/3.png') }}" alt="Icon">
                            <h5>Cabbage</h5>
                        </a>
                    </div>
                    <!-- End Single Item -->
                    ...
                    <div class="product-list-item">
                        <a href="services-details.html">
                            <img src="{{ asset('public/website/assets/img/icon/4.png') }}" alt="Icon">
                            <h5>Eggplant</h5>
                        </a>
                    </div>
                    <!-- End Single Item -->
                    ...
                    <div class="product-list-item">
                        <a href="services-details.html">
                            <img src="{{ asset('public/website/assets/img/icon/5.png') }}" alt="Icon">
                            <h5>Orange</h5>
                        </a>
                    </div>
                    <!-- End Single Item -->
                    ...
                    <div class="product-list-item">
                        <a href="services-details.html">
                            <img src="{{ asset('public/website/assets/img/icon/6.png') }}" alt="Icon">
                            <h5>Apples</h5>
                        </a>
                    </div>
                    <!-- End Single Item -->
            ...
            <div class="row align-center">
                <div class="col-lg-6 choose-us-style-one">
                    <div class="thumb">
                        <img src="{{ asset('public/website/assets/img/about/1.jpg') }}" alt="Image Not Found">
                        <div class="shape">
                            <img class="wow fadeInDown" src="{{ asset('public/website/assets/img/shape/22.png') }}" alt="Image not found">
                        </div>
    ...
    <!-- Start Testimonials
    ============================================= -->
    <div class="testimonials-area default-padding bg-gray" style="background-image: url({{ asset('public/website/assets/img/shape/23.png') }})">
        <div class="container">
            <div class="row align-center">
                <div class="col-lg-5">
                    <div class="testimonial-info text-center">
                        <h4>Testimonial</h4>
                        <div class="thumb">
                            <img src="{{ asset('public/website/assets/img/farmers/1.jpg') }}" alt="Image Not Found">
                            <img src="{{ asset('public/website/assets/img/farmers/4.jpg') }}" alt="Image Not Found">
                            <img src="{{ asset('public/website/assets/img/farmers/2.jpg') }}" alt="Image Not Found">
                            <img src="{{ asset('public/website/assets/img/farmers/3.jpg') }}" alt="Image Not Found">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 offset-lg-1">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="gallery-style-one">
                                    <img src="{{ asset('public/website/assets/img/gallery/2.jpg') }}" alt="Thumb">
                                    <div class="overlay">
                                        <span>Fruit</span>
                            ...
                            <div class="swiper-slide">
                                <div class="gallery-style-one">
                                    <img src="{{ asset('public/website/assets/img/gallery/7.jpg') }}" alt="Thumb">
                                    <div class="overlay">
                                        <span>Organic</span>
                            ...
                            <div class="swiper-slide">
                                <div class="gallery-style-one">
                                    <img src="{{ asset('public/website/assets/img/gallery/3.jpg') }}" alt="Thumb">
                                    <div class="overlay">
                            ...
                            <div class="swiper-slide">
                                <div class="gallery-style-one">
                                    <img src="{{ asset('public/website/assets/img/gallery/5.jpg') }}" alt="Thumb">
                                    <div class="overlay">
                                        <span>Cereals</span>
                            ...
                            <div class="swiper-slide">
                                <div class="gallery-style-one">
                                    <img src="{{ asset('public/website/assets/img/gallery/10.jpg') }}" alt="Thumb">
                                    <div class="overlay">
                                        <span>Havest</span>
    ...
    <div class="fun-facts-area default-padding">
        <div class="shape-left">
            <img src="{{ asset('public/website/assets/img/shape/27.png') }}" alt="Image Not Found">
        </div>
        <div class="container">
            <div class="item-inner">
                <div class="shape-right">
                    <img src="{{ asset('public/website/assets/img/shape/26.png') }}" alt="Image Not Found">
                </div>
                <div class="row">
    ...
    <!-- Start Contact Us
    ============================================= -->
    <div class="contact-area bg-gray default-padding" style="background-image: url({{ asset('public/website/assets/img/shape/28.png') }})">
        <div class="container">
            <div class="row align-center">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12 mb-30">
                    <div class="blog-style-one">
                        <div class="thumb">
                            <a href="blog-single-with-sidebar.html"><img src="{{ asset('public/website/assets/img/blog/v1.jpg') }}" alt="Image Not Found"></a>
                ...
                <div class="col-lg-3 col-md-6 mb-30">
                    <div class="blog-style-one">
                        <div class="thumb">
                            <a href="blog-single-with-sidebar.html"><img src="{{ asset('public/website/assets/img/blog/v2.jpg') }}" alt="Image Not Found"></a>
                ...
                <div class="col-lg-3 col-md-6 mb-30">
                    <div class="blog-style-one">
                        <div class="thumb">
                            <a href="blog-single-with-sidebar.html"><img src="{{ asset('public/website/assets/img/blog/v3.jpg') }}" alt="Image Not Found"></a>
