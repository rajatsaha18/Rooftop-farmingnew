<footer class="bg-dark text-light" style="background-image: url({{ asset('public/website/assets/img/shape/brush-down.png') }})">
                    ...
                    <div class="footer-item recent-post">
                        ...
                        <ul>
                            <li>
                                <div class="thumb">
                                    <a href="blog-single-with-sidebar.html">
                                        <img src="{{ asset('public/website/assets/img/thumbs/3.jpg') }}" alt="Thumb">
                                    </a>
                                </div>
                                <div class="info">
                            ...
                            <li>
                                <div class="thumb">
                                    <a href="blog-single-with-sidebar.html">
                                        <img src="{{ asset('public/website/assets/img/thumbs/5.jpg') }}" alt="Thumb">
                                    </a>
                                </div>
                                <div class="info">
                                    <div class="meta-title">
    ...
    <div class="shape-right-bottom">
        <img src="{{ asset('public/website/assets/img/shape/10.png') }}" alt="Image Not Found">
    </div>
    <div class="shape-left-bottom">
        <img src="{{ asset('public/website/assets/img/shape/11.png') }}" alt="Image Not Found">
    </div>
</footer>
