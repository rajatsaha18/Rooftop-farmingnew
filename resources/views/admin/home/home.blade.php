            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    @php
                        ...
                        $totalMembers       = DB::table('users')->where('role','user')->count();
                        $totalCategories    = DB::table('forum_categories')->count();
                    @endphp
                    <div class="flex-grow-1 ms-3">
                        <h6 class="mb-0">All Blogs</h6>
                    </div>
                </div>
                <div class="bg-body p-3 mt-3 rounded text-center">
                    <div class="text-center">
                        <h5 class="mb-1">{{ $totalBlogs }}</h5>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        <h6 class="mb-0">Total Forum Categories</h6>
                    </div>
                </div>
                <div class="bg-body p-3 mt-3 rounded text-center">
                    <div class="text-center">
                        <h5 class="mb-1">{{ $totalCategories }}</h5>
                    </div>
                </div>
            </div>
        </div>
